...
import com.eggcarol.storetechno.repositorios.UsuarioRepositorio;
...
public class UsuarioService  implements UserDetailsService{
    ...
    public void actualizar(MultipartFile archivo, String id, String nombre, String email, String password, String password2) throws MyException{
    ...
    private void validar(String nombre, String email, String password, String password2) throws MyException {
        ...
        if(password.isEmpty() || password == null || password.length()<= 5){
            throw new MyException("La contraseña no puede estar vacía y debe tener más de 5 digitos");
        }
